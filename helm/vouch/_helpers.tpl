...
{{/*
Selector labels for the CouchDB dependency.
The official couchdb chart uses:
  app.kubernetes.io/name: couchdb
  app.kubernetes.io/instance: <release-name>
We need these to target the Service to the CouchDB pods.
*/}}
{{- define "vouch.couchdbSelectorLabels" -}}
app.kubernetes.io/name: couchdb
app.kubernetes.io/instance: {{ .Release.Name }}
{{- end }}
